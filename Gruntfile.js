    ...
    buildcontrol: {
      dist: {
        options: {
          ...
          remote: 'git@github.com:simonsweeney/dm.git',
          branch: 'gh-pages'
        }
      }
    },
      ...
      dist: {
        options: {
          patterns: [
            {
              match: /("|'?)\/?styles\//g,
              replacement: '$1http://simonsweeney.github.io/dm/styles/'
            },
            {
              match: /("|'?)\/?scripts\//g,
              replacement: '$1http://simonsweeney.github.io/dm/scripts/'
            },
            {
              match: /(<a[^>]*href="?)(\/)/g,
              replacement: '$1http://simonsweeney.github.io/dm/'
            },
            {
              match: /(<form[^>]*action="?)(\/)/g,
              replacement: '$1http://simonsweeney.github.io/dm/'
